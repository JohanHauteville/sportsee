            ...
            <article className='pie-chart-article'>
                <ResponsiveContainer width="100%" height="100%">
                    <PieChart  >
                        ...
                        <Pie data={Array(this.props.data)} dataKey="todayScore" cx="50%" cy="50%" cornerRadius={10} innerRadius={"62%"} outerRadius={"70%"} fill="#FF0000" startAngle={90} endAngle={((this.props.data.todayScore * 360) + 90)} />
